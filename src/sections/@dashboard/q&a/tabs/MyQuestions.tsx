...
// operators
import getUserQuestions from '@/modules/q&a/redux/operators/getUserQuestions';
// hooks
...
export default function MyQuestions() {
  ...
  const {
    ...
    questions,
  } = useSelector((s) => s.qAndA.userQuestions);
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    dispatch(getUserQuestions(searchParams.toString(), successCallback, failureCallback));
  }, [dispatch, page]);
