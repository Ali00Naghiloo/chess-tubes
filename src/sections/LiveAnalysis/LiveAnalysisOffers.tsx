...
import OfferCourseCard from '@/components/live-analysis-card/offer-course/OfferCourseCard';

// ----------------------------------------------------------------------

export default function LiveAnalysisOffers() {
  //

  const isMobile = useResponsive('down', 'sm');

  const { pageCourses } = useSelector((s) => s.liveAnalysis);
