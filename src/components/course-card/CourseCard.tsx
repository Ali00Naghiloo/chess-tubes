...
// models
import { CourseCardProps } from '@/modules/course/models/course';
// paths
...
export default function CourseCard({
  ...
  return (
    <Paper
      ...
      sx={{
        width: 250,
        height: isMini ? 400 : 420,
        cursor: 'pointer',
        '&:hover': { boxShadow: (theme) => theme.shadows[2] },
        ...(sx != null && sx),
      }}
    >
      <Link underline="none" color="inherit" href={PATH_PAGE.course(courseId)}>
        <Image
          alt={title}
              ...
              {!isMini && (
                <>
                  ...
                  <Stack direction="row" spacing={1} dir="rtl">
                    ...
                    <Typography variant="body2" fontWeight={600}>
                      {enNumToPer(Number(studentCount))} شرکت کننده
                    </Typography>
                  </Stack>
                </>
              )}
