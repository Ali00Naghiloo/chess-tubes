...
export type MiniFavCourseCardProps = PaperProps & {
  image: string;
  name: string;
  rating: string;
  teacher: string;
...
export default function MiniFavCourseCard({
  image,
  name,
  offPercent,
  offPrice,
    ...
    >
      <Link href="/courses/1" color="inherit" underline="none">
        <Stack direction="row-reverse">
          ...
          <Stack sx={{ flexGrow: 1, py: 1 }} justifyContent="space-between">
